  ...
  return (
    <header className='flex justify-between'>
        ...
        <Link to={'/'} className='flex items-center gap-1'>
          ...
          <span className='font-bold text-xl'>ural</span>
        </Link>
        ...
        <Link to={user?'/account':'/login'} className='flex items-center yard add gap-2 border border-gray-300 rounded-full py-2 px-4'>
